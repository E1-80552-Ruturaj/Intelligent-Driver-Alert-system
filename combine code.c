...
//void floatToBytes(float value, uint8_t *bytearray) {
...
//	  		floatToBytes(distance, &TxData[0]);
//	  		if(HAL_CAN_AddTxMessage(&hcan1, &TxHeader, TxData, &TxMailBox)!= HAL_OK)
//	  		  				Error_Handler();
//	  		HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_SET);
	HAL_Delay(2000);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7|TRIG_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA4 ECHO_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_4|ECHO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PA7 TRIG_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_7|TRIG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
